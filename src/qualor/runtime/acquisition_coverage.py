...
class CoverageLedger:
    ...
    def __init__(self, index: SectionIndex, plan: AcquisitionPlan) -> None:
        self._index = index
        self._plan = plan
        self._states = {category: AcquisitionState.UNSEEN for category in Category}
        self._transitions: list[CoverageTransition] = []
        self._attempts: set[AttemptKey] = set()
        self._attempt_tiers: dict[AttemptKey, AcquisitionTier] = {}
    ...
    @property
    def attempt_tiers(self) -> Mapping[AttemptKey, AcquisitionTier]:
    ...
    def replace_index(self, index: SectionIndex, plan: AcquisitionPlan) -> None:
