...
def test_all_public_types_compile_and_reject_invalid_contracts(tmp_path):
    ...
    consumer.write_text(
        ...
        + ", Money, InboxPresentationState} from './domain';\n"
        ...
        "const nullState: InboxItem['presentation_state'] = null;\n"
        "declare const item: InboxItem;\n"
        "const {presentation_state, ...missingState} = item;\n"
        "// @ts-expect-error presentation state is required\n"
        "const incompleteItem: InboxItem = missingState;\n"
